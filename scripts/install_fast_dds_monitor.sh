...
wget https://github.com/eProsima/Fast-DDS-statistics-backend/archive/refs/tags/v0.7.1.tar.gz
tar xvf v0.7.1.tar.gz
cd Fast-DDS-statistics-backend-0.7.1
mkdir build
cd build
cmake ..
make
...
cd fastdds_monitor
wget https://github.com/eProsima/Fast-DDS-monitor/archive/refs/tags/v1.2.1.tar.gz

tar xvf v1.2.1.tar.gz

cd Fast-DDS-monitor-1.2.1
