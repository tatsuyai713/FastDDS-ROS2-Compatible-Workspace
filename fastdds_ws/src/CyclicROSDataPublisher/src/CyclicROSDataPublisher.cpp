...
/**
 * @file CyclicROSDataPublisher.cpp
 *
 */

#include "CyclicROSDataPublisher.h"
...
CyclicROSDataPublisher::CyclicROSDataPublisher()
    : participant_(nullptr)
    , publisher_(nullptr)
    , topic_(nullptr)
    , writer_(nullptr)
    , type_(new geometry_msgs::msg::PosePubSubType())
    , domain_number_(0)
...
bool CyclicROSDataPublisher::init(std::string config_file_path)
{
    ...
    publish_msg_ = std::make_shared<geometry_msgs::msg::Pose>();    
...
void CyclicROSDataPublisher::PubListener::on_publication_matched(
...
void CyclicROSDataPublisher::runThread()
{
	int ret;
...
void CyclicROSDataPublisher::run()
{
    timer_t timer_id;
    ...
    std::thread thread(&CyclicROSDataPublisher::runThread, this);
...
bool CyclicROSDataPublisher::publish(bool waitForListener)
{
