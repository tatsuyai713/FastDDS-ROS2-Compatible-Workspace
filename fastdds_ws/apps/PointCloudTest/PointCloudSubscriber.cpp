...
PointCloudSubscriber::PointCloudSubscriber()
    : participant_(nullptr), subscriber_(nullptr), topic_(nullptr), reader_(nullptr), type_(new sensor_msgs::msg::PointCloud2PubSubType())
{
}

bool PointCloudSubscriber::init(
    bool use_env)
{
...
void PointCloudSubscriber::SubListener::on_subscription_matched(
    DataReader *,
...
void PointCloudSubscriber::SubListener::on_data_available(
    DataReader *reader)
{
    SampleInfo info;
